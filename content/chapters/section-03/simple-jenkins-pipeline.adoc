...
image:gitea-ssh-url.png[height=50]
...
** La "stage" *Test* doit publier les rapports de test d'intégration au format `junit`
*** _Indices :_ Dans le dossier `target/failsafe-reports`, motif `{asterisk}{asterisk}/{asterisk}.xml`
